...
uint8_t capture_done = 0;//show that DMA done transfer
...
{
    // Test on DMA1 Channel1 half transfer interrupt */
  if (DMA_GetITStatus(DMA1_IT_HT1))
  {
    /* Clear DMA1 Channel1 half transfer interrupt pending bits */
    DMA_ClearITPendingBit(DMA1_IT_HT1);
  }
  else  if(DMA_GetITStatus(DMA1_IT_TC1)) /* Test on DMA1 Channel1 transfer complete interrupt */
  {
