...
volatile uint16_t adc_capture_buffer1[ADC_CAPURE_BUF_LENGTH];//signal+reference points - freq1
volatile uint16_t adc_capture_buffer2[ADC_CAPURE_BUF_LENGTH];//signal+reference points - freq2
volatile uint16_t adc_capture_buffer3[ADC_CAPURE_BUF_LENGTH];//signal+reference points - freq3
...
//reconfigure dma and start adc capture
