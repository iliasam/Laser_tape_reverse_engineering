...
//Tripple buffering - rolling buffer for writing data
volatile captured_data_t captured_data1;
volatile captured_data_t captured_data2;
volatile captured_data_t captured_data3;
...
void init_adc_capture_dma(void)
{
  ...
  DMA_InitStructure.DMA_MemoryBaseAddr = (uint32_t)captured_data1.adc_capture_buffer;
